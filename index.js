...
var FormException = function () {
  function FormException(errors) {
    _classCallCheck(this, FormException);

    this.errors = errors;
  }

  _createClass(FormException, [{
    key: "content",
    get: function get() {
      return this.errors;
    }
...
var Form = function () {
  ...
  _createClass(Form, [{
    ...
    key: "mountField",
    value: function mountField(name, field) {
    ...
    key: "startAllHooks",
    value: function startAllHooks() {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = _getIterator(this.fields), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    key: "startHook",
    value: function startHook(name, field) {
      var subscribers = this.subscribers.get(name) || new _Set();
      var _iteratorNormalCompletion2 = true;
      var _didIteratorError2 = false;
      var _iteratorError2 = undefined;

      try {
        for (var _iterator2 = _getIterator(subscribers), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var _ref4 = _step2.value;
          var options = _ref4.options,
              subscriber = _ref4.subscriber;

          field.subscribe(this.wrapSubscriber(options.valid, subscriber), { immediate: options.immediate });
        }
      } catch (err) {
    ...
    key: "wrapSubscriber",
    value: function wrapSubscriber(valid, subscriber) {
      var _this = this;
      ...
      return function (_ref5) {
        ...
        subscriber.call(_this.target, { value: value, prevValue: prevValue, message: message });
      };
    }
  }, {
    key: "unmountFiled",
    value: function unmountFiled(name) {
    ...
    key: "notifyChange",
    value: function notifyChange(fieldName, update) {
      var subscribers = this.subscribers.get(fieldName) || new _Set();
      var _iteratorNormalCompletion3 = true;
      var _didIteratorError3 = false;
      var _iteratorError3 = undefined;

      try {
        for (var _iterator3 = _getIterator(subscribers), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var _ref6 = _step3.value;
          var options = _ref6.options,
              subscriber = _ref6.subscriber;
    ...
    key: "validate",
    value: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        var errors, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, _ref8, _ref9, name, component, _ref10, error, message;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 4;
                _iterator4 = _getIterator(this.fields);
              ...
              case 13:
                ...
                if (error) errors.push({ field: name, message: message });
    ...
    key: "submit",
    value: function () {
      var _ref11 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
        var result, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _ref12, _ref13, name, componentInstance;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                for (_iterator5 = _getIterator(this.fields); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                  _ref12 = _step5.value;
                  _ref13 = _slicedToArray(_ref12, 2);
                  name = _ref13[0];
                  componentInstance = _ref13[1];
...
var watchFieldMetadataKey = '__fnFormFieldSubscribers';

var getSubscribers = function getSubscribers(prototype) {
  var descriptor = _Object$getOwnPropertyDescriptor(prototype, watchFieldMetadataKey);
  if (!descriptor) {
    descriptor = {
      value: new _Map(),
      enumerable: false,
    ...
    _Object$defineProperty(prototype, watchFieldMetadataKey, descriptor);
  }
...
var watchField = function watchField(fieldName) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return function (prototype, propName, listenerDescriptor) {
    var map = getSubscribers(prototype);
    if (!map.has(fieldName)) map.set(fieldName, new _Set());
    map.get(fieldName).add({
      options: _Object$assign({}, defaultOptions, options), subscriber: listenerDescriptor.value
    });
  };
};

var formKey = '__rnForm';
...
var formHOC = function formHOC(WrappedComponent) {
  var newComponent = function (_React$Component) {
    ...
    function newComponent(props) {
      ...
      var _this = _possibleConstructorReturn(this, (newComponent.__proto__ || _Object$getPrototypeOf(newComponent)).call(this, props));
    ...
    _createClass(newComponent, [{
      ...
      value: function getChildContext() {
        return _defineProperty({}, formKey, this.form);
      }
    }, {
      ...
      value: function render() {
        var allProps = _extends$1({}, this.props, { form: this.form });
  ...
  newComponent.childContextTypes = _defineProperty({}, formKey, propTypes.object);
...
var Subscribe = function () {
  ...
  _createClass(Subscribe, [{
    ...
    key: "fixedVersion",
    value: function fixedVersion() {
      var subscribe = new Subscribe(this.value);
...
var Field = function () {
  ...
  _createClass(Field, [{
    ...
    value: function setValue(value) {
      ...
      this.value = value;
      var fixedSubscribers = this.subscribers.fixedVersion();
      this.validate().then(function (_ref2) {
        var message = _ref2.message;
        return fixedSubscribers.trigger({ value: value, prevValue: prevValue, message: message });
      });
    }
  }, {
    key: "getValue",
    ...
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        var validatorIterator, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _ref4, message, _validate, valid;

        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                validatorIterator = _getIterator(this.validators);
                _iteratorNormalCompletion = true;
                _didIteratorError = false;
                _iteratorError = undefined;
                _context.prev = 4;
                _iterator = _getIterator(validatorIterator);
              ...
              case 6:
                ...
                _ref4 = _step.value;
                message = _ref4.message, _validate = _ref4.validate;
                _context.next = 11;
                return _validate(this.value);
              ...
              case 11:
                ...
                return _context.abrupt("return", { error: true, message: message });
              ...
              case 31:
                return _context.abrupt("return", { error: false });
    ...
    value: function subscribe(fn) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { immediate: true };
...
var fieldHOC = function fieldHOC(Component) {
  var _class, _temp;
